    ...
    <div class="center">
      ...
      {{@csrf_field()}}
        ...
        <div class="signup_link">
          ...
          <br>
         Sign Up As<br>
          <a href="{{route('admin.registration')}}">Admin</a>|<a href="{{route('manager.registration')}}">Manager</a>|<a href="{{route('admin.registration')}}">Staff</a>|<a href="{{route('customer.registration')}}">Customer</a>
