 ...
 --></center>
  	...
  	<tr>		
  		...
  		<td style=" background-image: url('backImage.jpg');">
            <center><a href="addBranchData.php"><button style="color: seagreen;">Enter New Data</button></a><br><br>
         <a href="showBranch.php"><button style="color: saddlebrown;">Branch Results</button></a></center>
